from PySide6.QtWidgets import QWidget, QVBoxLayout, QLayout, QSizePolicy, QHBoxLayout, QLabel, QFrame, QScrollArea
from PySide6.QtCore import Qt, QRect, QSize, QMargins, QPoint, QRectF
